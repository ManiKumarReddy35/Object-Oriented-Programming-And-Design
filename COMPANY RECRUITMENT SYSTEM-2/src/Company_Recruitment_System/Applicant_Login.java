 ...
 * @author Sai Kumar
 */
public class Applicant_Login extends javax.swing.JFrame {

    /**
     * Creates new form Applicant_Login
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      boolean val = a.length()!=0 && b.length()!=0;
      boolean val1 = a.contains("@")&&a.contains(".");
      if(val && val1)
      {
        try {  
            Class.forName("com.mysql.jdbc.Driver");
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(Applicant_Login.class.getName()).log(Level.SEVERE, null, ex);
        }
      Connection con=null;
        try {
      ...
      String query = "select * from Registration where mailid='"+a+"' and pwd='"+b+"'";
      ResultSet rs = null;
        try {
        ...
        try {
            if(rs.next())
            {
                ...
                Applicant_Dashboard ad = new Applicant_Dashboard(a);
                ad.setVisible(true);
                jTextField1.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Applicant_Register ar=new Applicant_Register();
        ar.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Applicant_Login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Applicant_Login().setVisible(true);
            }
        });
    }
